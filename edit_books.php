<?php
	...
	if(isset($_GET['editID'])){
		$book_id=$_GET['editID'];
		$book_data=fetchBookDetails($conn, $book_id);
		$book_image='uploads/'.$book_data['book_image'];
	}
	...
	if(array_key_exists('submit', $_POST)){
		...
		if(empty($error)){
			...
			$outcome = editBook($conn, $clean, $book_id);
			if($outcome){
				$success=true;
			}
		}
...
<body>
	...
	<div>
		...
		<form action="" method="post" enctype="multipart/form-data" id="form">
			...
			<div class="form-wrapper">
				<p><input type="submit" name="submit" value="Edit Details" id="details"></p>
			</div>
		</form>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p class="success-text">Sucessfully Edited Book Information</p>
				</div>
			</div>
		</div>
	</div>
